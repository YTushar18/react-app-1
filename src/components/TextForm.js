...
export default function TextForm(props) {
  ...
  return (
    ...
    <div style={{ color:props.mode==='light'?'black':'white', backgroundColor:props.mode==='light'?'white':'#121212'}}>
      ...
      <button type="button" class="btn btn-light mx-2" onClick={handleClearClick}>Clear Text</button>
      <button type="button" class="btn btn-light mx-2" onClick={handleTextCopy}> Copy Text <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard" viewBox="0 0 16 16">
